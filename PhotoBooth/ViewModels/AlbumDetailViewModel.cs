...
{
    public class AlbumDetailViewModel : ObservableRecipient, INavigationAware
    {
        ...
        public AlbumDetailViewModel(ISampleDataService sampleDataService, INavigationService navigationService)
        {
